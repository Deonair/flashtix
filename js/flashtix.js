...
$('#lastminutecontent').append('<img id="theImg" src="img/newimage.jpg" height="100px"/>');
...
if(localStorage.getItem('shakira')!==null) {
    ...
    $('#etickets').append(
        '<p>Eticket Playstation concert</p><img src="' + eticket + '" alt="pic" width="35%">');
}
...
var marker = new google.maps.Marker({
    position: SVGTextPositioningElement,
